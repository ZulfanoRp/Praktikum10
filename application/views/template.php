...
<body class="theme-red">
    ...
    <section>
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="user-info">
                <div class="image">
                    <img src="<?=base_url()?>/assets/fano.jpg" width="48" height="48" alt="User" />
                </div>
                <div class="info-container">
                    <div class="name" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Zulfano Rizqullah Pramono</div>
                    <div class="email">zulfano_rizqullah_26rpl@student.smktelkom-mlg.sch.id</div>
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li>
                        <a href="<?=base_url('index.php/user/DaftarPelanggan')?>">
